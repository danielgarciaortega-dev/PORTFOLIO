...
import {
  technologyGroups as enTechnologyGroups,
} from '../src/data/en/technologies.ts';
...
import {
  technologyGroups as esTechnologyGroups,
} from '../src/data/es/technologies.ts';
...
test(
  'education and experience namespaces keep facts aligned without copy leakage',
  () => {
...
test(
  'technology namespaces preserve stacks while localizing labels deterministically',
  () => {
