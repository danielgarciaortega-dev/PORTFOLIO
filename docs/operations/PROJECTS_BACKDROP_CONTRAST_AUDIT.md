...
| Moment | Composition | Desktop risk | Mobile risk | Diagnostic p05 contrast: metadata / description |
| --- | --- | --- | --- | --- |
| 01 | Bright indoor group portrait with alternating light walls, skin tones and dark clothing. | Secondary text crosses several dark shirts and medium-tone faces. The cream veil reduces separation instead of creating a stable text plane. | The center crop places people directly behind the first card copy. | Desktop **1.91 / 1.86**; mobile **2.45 / 2.15** |
| 02 | Large group portrait with very bright ceiling panels, mixed clothing and saturated green floor. | Highest spatial variation of the six images. Copy crosses faces, dark clothing and bright areas in the same card. | The first card sits over multiple subjects and the green seating/floor. | Desktop **1.77 / 1.73**; mobile **1.88 / 1.97** |
| 03 | Presenter in black clothing against a bright wall with a large green plant. | The first card combines dark clothing and foliage while the other columns sit on pale wall/screen regions, so one global cream treatment behaves inconsistently. | The presenter occupies most of the visible crop behind the first project. | Desktop **1.80 / 1.84**; mobile **2.10 / 1.94** |
| 04 | Close portrait with dark clothing, skin and hair in the center/right; blurred presenter in the background. | The portrait is visually dominant and competes with project hierarchy. Secondary text can fall over dark clothing and skin in adjacent columns. | Strongest focal competition of the set: a face occupies most of the viewport behind the first project. | Desktop **1.80 / 1.87**; mobile **3.42 / 3.34** |
| 05 | Award group portrait with a bright white left side and saturated orange display/signage. | Mixed dark clothing, white walls and orange signage create abrupt luminance changes under the three cards. The current halo becomes especially visible. | Award signage and people remain directly behind copy, creating visual noise even where raw contrast is acceptable. | Desktop **1.74 / 1.81**; mobile **2.21 / 2.27** |
| 06 | Portrait-oriented outdoor group with pale UGR AI facade/sky and the group in the lower half. | The facade is comparatively calm, but the lower copy crosses the group and award boards. | The existing `center 55%` adjustment is justified: it keeps the group visible. Description contrast still drops over the people/award region. | Desktop **2.22 / 1.85**; mobile **4.80 / 2.05** |
